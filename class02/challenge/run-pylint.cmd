...
env\Scripts\pylint.exe app\controllers\careers_by_average_age.py
env\Scripts\pylint.exe app\controllers\city_with_more_careers.py
env\Scripts\pylint.exe app\controllers\students_by_age.py
env\Scripts\pylint.exe app\controllers\students_by_average_age.py
env\Scripts\pylint.exe app\controllers\students_by_city.py
env\Scripts\pylint.exe app\controllers\students_by_country.py
...
env\Scripts\pylint.exe app\models\careers_by_average_age.py
env\Scripts\pylint.exe app\models\city_with_more_careers.py
env\Scripts\pylint.exe app\models\data.py
env\Scripts\pylint.exe app\models\students_by_age.py
env\Scripts\pylint.exe app\models\students_by_average_age.py
...
env\Scripts\pylint.exe app\views\careers_by_average_age.py
env\Scripts\pylint.exe app\views\city_with_more_careers.py
env\Scripts\pylint.exe app\views\students_by_age.py
env\Scripts\pylint.exe app\views\students_by_average_age.py
env\Scripts\pylint.exe app\views\students_by_city.py
env\Scripts\pylint.exe app\views\students_by_country.py
env\Scripts\pylint.exe app\views\students_cities_residence.py
pause