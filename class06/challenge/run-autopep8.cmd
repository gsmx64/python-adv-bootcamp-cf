...
env\Scripts\autopep8.exe -i -r app\controllers\recital.py
...
env\Scripts\autopep8.exe -i -r app\models\recital.py
...
env\Scripts\autopep8.exe -i -r app\views\recital.py
